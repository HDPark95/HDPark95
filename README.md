...
| 프로젝트 | 내용 |
|---|---|
| [spring-cloud/spring-cloud-stream#3244](https://github.com/spring-cloud/spring-cloud-stream/pull/3244) | 해시 키가 충돌하는 케이스를 재현, 값 기반 캐시 키로 재작성됨 |
| [datahub-project/datahub#19144](https://github.com/datahub-project/datahub/pull/19144) | URN 매핑이 없을 때 자산이 lineage에서 빠지는 스킵 로직 제보 |
| [micronaut-projects/micronaut-core#12871](https://github.com/micronaut-projects/micronaut-core/pull/12871) | 새 쿠키 디코더가 미종결 따옴표를 Netty와 다르게 처리하는 것 확인 |
| [spring-cloud/spring-cloud-gateway#4261](https://github.com/spring-cloud/spring-cloud-gateway/pull/4261) | 검증된 적 없는 `LIST_TAIL_FLAG`가 함께 켜지는 것 지적, e2e 테스트 추가됨 |
| [ollama/ollama#17630](https://github.com/ollama/ollama/pull/17630) | `Failed to parse tools` 메시지의 실제 출처가 native runner임을 추적 |
| [ollama/ollama#17809](https://github.com/ollama/ollama/pull/17809) | 파서 테스트 케이스 검증, 무의미한 케이스와 미검증 회귀 지적 |
